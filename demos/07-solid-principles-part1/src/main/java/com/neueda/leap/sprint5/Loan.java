...
// quantity (number of items loaned) can never go negative. If quantity were a public
// field, EVERY piece of code anywhere in the codebase that touches a Loan would be
// individually responsible for remembering that rule - and it only takes one careless
// line, anywhere, to break it. Making the field private and only exposing a validated
// method to change it means the rule is enforced in exactly one place, permanently.
// Renamed from Holding.
public class Loan {
